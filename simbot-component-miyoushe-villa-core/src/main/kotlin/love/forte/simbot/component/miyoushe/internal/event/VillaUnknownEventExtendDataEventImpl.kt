...
import love.forte.simbot.component.miyoushe.event.VillaUnknownEventExtendDataEvent
 ...
 * @author ForteScarlet
 */
internal class VillaUnknownEventExtendDataEventImpl(
    override val bot: VillaBotImpl,
    override val sourceEvent: Event<UnknownEventExtendData>,
    override val sourceEventSource: EventSource
) : VillaUnknownEventExtendDataEvent()
