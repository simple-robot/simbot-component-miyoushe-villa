 ...
 * @see ApiResult
 */
public open class ApiResultNotSuccessException : IllegalStateException {
    @Suppress("MemberVisibilityCanBePrivate")
    public val apiResult: ApiResult<*>

    public constructor(apiResult: ApiResult<*>) : super(apiResult.toReasonString()) {
        this.apiResult = apiResult
    }

    public constructor(apiResult: ApiResult<*>, message: String?) : super(message) {
        this.apiResult = apiResult
    }

    public constructor(apiResult: ApiResult<*>, message: String?, cause: Throwable?) : super(message, cause) {
        this.apiResult = apiResult
    }

    public constructor(apiResult: ApiResult<*>, cause: Throwable?) : super(cause) {
        this.apiResult = apiResult
    }
}
